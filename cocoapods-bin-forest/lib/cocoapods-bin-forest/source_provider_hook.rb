require 'cocoapods-bin-forest/native/sources_manager'
require 'cocoapods-bin-forest/command/bin/repo/update'
require 'cocoapods/user_interface'

Pod::HooksManager.register('cocoapods-bin-forest', :pre_install) do |_context, _|
  ...
  if _context.podfile.plugins.keys.include?('cocoapods-bin-forest') && _context.podfile.configuration_env == 'dev'
...
Pod::HooksManager.register('cocoapods-bin-forest', :source_provider) do |context, _|
