...
require 'cocoapods'
require 'cocoapods-bin-forest/native/podfile_env'
...
module Pod
  class Podfile
    ...
    def valid_bin_plugin
      unless plugins.keys.include?('cocoapods-bin-forest')
        raise Pod::Informative, 'You should add `plugin \'cocoapods-bin-forest\'` before using its DSL'
      end
    end
